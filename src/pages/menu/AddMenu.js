...
const AddMenu = () => {
    ...
    const [inputList, setInputList] = useState([{ subMenu: '', selectedSubMenuId: '', id_subMenu: 1 }]);
    ...
    const handleSubmit = async (e) => {
        ...
        if(!subMenus || subMenus.length === 0){
            ...
            try{
                ...
                const addMenu = await axios.post('https://api-indita.vercel.app/addMenu', {
                    nama_menu,
                    deskripsi_menu,
                    id_kategori: 1,
                    id_subMenu: inputList.map((item) => parseInt(item.selectedSubMenuId)),
                },
                {
                    headers: {
                        'Content-Type': 'application/json',
    ...
    const handleAddClick = () => {
        ...
        const selectedSubMenuId = inputList.length === 0 ? newSubMenuId : '';
                        ...
                        <div className="p-6 overflow-x-scroll px-0 pt-4 pb-2">
                            ...
                            <div className="flex items-center space-x-3 w-full ml-4 mt-4 px-8 mb-4" key={index}>
                                <div className="relative h-10 flex-grow min-w-[200px]">
                                    {!setSubMenus || setSubMenus === undefined ||  !subMenus || subMenus.length === 0 ? (
                                    ...
                                    // Tampilkan select option jika setSubMenus tidak kosong dan subMenus tidak kosong
                                    <select
                                        name="selectedSubMenuId"
                                        value={x.selectedSubMenuId}
                                        ...
                                        required
                                    >
                                        <option value="Nothing sub menu" className="bg-gray-500">Nothing sub menu</option>
