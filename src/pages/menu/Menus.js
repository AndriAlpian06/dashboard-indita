...
const Menus = () => {
  ...
  useEffect(() => {
    axios.get('https://api-indita.vercel.app/menu')
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedMenuId !== null) {
      axios.get(`https://api-indita.vercel.app/menuToSubMenu/${selectedMenuId}/subMenu`)
        .then((response) => {
  ...
  const handleDeleteMenuId = async () => {
    try{

      if(deleteMenuId) {
        
        const apiUrl = `https://api-indita.vercel.app/deleteMenu/${deleteMenuId}`;
                      ...
                      {/* <table className="w-full min-w-[640px] table-auto">
                        <thead>
                          <tr>
                            ...
                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                              <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">Nama Menu
                              </p>
                            </th>
                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                              <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">Kategori
                              </p>
                            </th>
                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                              <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">Deskripsi Menu
                              </p>
                            </th>
                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                          ...
                          <tbody>
                            {menuData.data && menuData.data.map((menu, index) => (
                              <tr key={index}>
                                ...
                                <td className="py-3 px-5 space-x-4" style={{ display: 'flex', alignItems: 'center' }}>
                                  ...
                                  <button className="middle none center rounded-lg bg-white-200 py-3 px-6 font-sans text-xs font-bold uppercase text-black shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" 
                                    onClick={openSubMenu}
                                ...
                                <th className="py-3 px-5 text-left">
                                  <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">
                                    {menu.subMenus.map((subMenuItem, subMenuIndex) => (
                                      <span key={subMenuItem.id}>
                                        {subMenuItem.subMenu.subMenu}
                                        {subMenuIndex < menu.subMenus.length - 1 && ", "}
                                      </span>
                                    ))}
                                  </p>
                                </th>
                                ...
                                {modalIsOpenSubMenu && (
                                  <Transition appear show={true} as={Fragment}>
                                    <Dialog as="div" className="relative z-10" onClose={() => setModalIsOpenSubMenu(false)}>
                                      <Transition.Child
                                          as={Fragment}
                                                      ...
                                                      <table className="w-full min-w-[640px] table-auto">
                                                        <thead>
                                                          <tr>
                                                            ...
                                                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                                                              <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">Sub Menu
                                                              </p>  
                                                            </th>
                                                            <th className="border-b border-blue-gray-50 py-3 px-5 text-left">
                                                        ...
                                                        <tbody>
                                                          {menu.subMenus && menu.subMenus.map((subMenuItem, subMenuIndex) => (
                                                            <tr key={subMenuItem.id}>
                                                              ...
                                                              <td className="py-3 px-5 text-left">
                                                                <p className="block antialiased font-sans text-[11px] font-bold uppercase text-blue-gray-400">
                                                                  {subMenuItem.subMenu.deskripsi_subMenu}
                                                                </p>
                                                              </td>
                                                            </tr>
                                                          ))}
                          ...
                          {menuData && menuData.map((menu, index) => (
                            <tr key={menu.id} className={`cursor-pointer ${menu.id === selectedMenuId ? 'bg-gray-200' : ''}`}>
                              ...
                              <td className="py-3 px-5 space-x-4" style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                {/* {isSubMenuVisible ? (
                                  // Tombol dengan panah ke atas (up arrow)
                                  <button
                                    className="middle none center rounded-lg bg-white-200 py-3 px-4 font-sans text-xs font-bold uppercase text-black shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                  ...
                                  // Tombol dengan panah ke bawah (down arrow)
                                  <button
                                    className="middle none center rounded-lg bg-white-200 py-3 px-4 font-sans text-xs font-bold uppercase text-black shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                    onClick={() => handleMenuClick(menu.id)}
                                    style={{ border: '1px solid blue' }}
