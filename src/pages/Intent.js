            ...
            <Navbar />
              <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md overflow-hidden xl:col-span-2">
                <div className="relative bg-clip-border rounded-xl overflow-hidden bg-transparent text-gray-700 shadow-none m-0 flex items-center justify-between p-6">
                  <div>
                    <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-1">Menu</h6>
                  </div>
                </div>
                <div className="p-6 overflow-x-scroll px-0 pt-0 pb-2">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th className="border-b border-blue-gray-50 py-3 px-6 text-left">
                        <p className="block antialiased font-sans text-[11px] font-medium uppercase text-blue-gray-400">Nama Menu</p>
                      </th>
                      <th className="border-b border-blue-gray-50 py-3 px-6 text-left">
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Silahkan sampaikan kendala internet yang sobat alami</p>
                      </td>
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Pengaduan Kendala</p>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Promo apa yang sobat ingin ketahui</p>
                      </td>
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Promo</p>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Paket apa yang sobat ingin ketahui</p>
                      </td>
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Paket</p>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Tagihan</p>
                      </td>
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Silahkan sampaikan kendala Tagihan yang sobat alami</p>
                      </td>
                      <td className="py-3 px-5 border-b border-blue-gray-50">
                        <p className='block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-bold'>Informasi Tagihan</p>
                      </td>
