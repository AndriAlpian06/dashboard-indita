...
const EditSubMenu = () => {
    ...
    useEffect(() => {
        axios.get(`https://api-indita.vercel.app/subMenu/${id}`)
        .then((response) => {
            const menuData = response.data.data
            //console.log(menuData)
            setSubMenu(menuData.subMenu)
            setDeskripsiSubMenu(menuData.deskripsi_subMenu)
        })
        .catch((error) => {
            console.error(error);
        });
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            const updateSubMenu = await axios.patch(`https://api-indita.vercel.app/subMenu/${id}`, {
                    subMenu,
                    deskripsi_subMenu,
                },
                {
